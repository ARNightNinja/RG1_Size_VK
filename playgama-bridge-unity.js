...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/813700ccfaf64a0a3c57e3aa3166490b.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/0d2e0c4b0c76e39d446ef8652dd00a5f.data.unityweb',
                        frameworkUrl: 'Build/05ed860affeef57ec7f52c62c55664bc.framework.js.unityweb',
                        codeUrl: 'Build/62134e40da1d8b905b6a0ecd27a19834.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'Obby.Parkour',
                        productName: 'ObbyGame',
                        productVersion: '0.1',
